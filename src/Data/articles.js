const Articles = [
  ...
  {
    id: 3,
    title: "Caja de colores Faber Castell",
    description: "",
    category: "Instrumentos escolares",
    image: "/Images/3.webp"
  },
  {
    id: 4,
    title: "Cuaderno Gloria Tapa Dura",
    description: "",
    category: "Instrumentos escolares",
    image: "/Images/4.webp"
  },
  ...
  {
    id: 9,
    title: "Resaltador Amarillo Sharpie",
    description: "",
    category: "Instrumentos escolares",
    image: "/Images/9.webp"
  },
  ...
  },
  {
    ...
    description: "",
    category: "Material de Arte, Manualidades, Decoraciones",
...
// Recorrer todos los elementos y agregar el precio
/* for (let i = 0; i < Articles.length; i++) {
  Articles[i].price = `$${Math.floor(Math.random() * (500 - 50 + 1)) + 50}.00`;
} */
